  ...
  return (
    <QueryClientProvider client={queryClient}>
      <ThemeProvider>
        ...
        <Route path="/">
          {player ? <GameHub player={player} onLogout={handleLogout} onNavigate={() => {}} /> : <Login onLogin={handleLogin} />}
        </Route>
        <Route path="/homepage">
          <Homepage />
        </Route>
        <Route path="/game">
          {player ? <Game player={player} onLogout={handleLogout} /> : <EnhancedLogin onLogin={handleLogin} />}
        </Route>
        <Route>
          <NotFound />
        </Route>
